...
const translations = {
    es: {
        ...
        club_benefit_prices: 'Precios sin aumento de 1€',
    ...
    en: {
        ...
        club_benefit_prices: 'Prices without €1 increase',
...
function loadClub() {
    ...
    const benefitItems = ['club_benefit_prices', 'club_benefit_beverage', 'club_benefit_upgrades', 'club_benefit_rewards'];
